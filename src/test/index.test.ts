...
test.describe('Instagram post clone', () => {
    ...
    test.beforeEach(async ({ page }) => {
        await page.goto('file:///C:/Users/shakede/onBording/Instagram-post-clone/public/index.html');
    });

    test('Check for the correct URL', async ({ page }) => {
        await expect(page).toHaveURL('file:///C:/Users/shakede/onBording/Instagram-post-clone/public/index.html');
    });
    ...
    test('Add comment with Enter', async ({ page }) => {
        ...
        const commentsInnerText = page.locator('.commentHeader > div > span').last();
